...
public class BillingForm extends javax.swing.JFrame {
    ...
    public BillingForm() {
        ...
        txtConsultationFee.setText(String.format("%.2f", CONSULTATION_FEE));
    }
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        if (!"APPROVED".equalsIgnoreCase(currentAppointment.getStatus()) && !"COMPLETED".equalsIgnoreCase(currentAppointment.getStatus())) {
            JOptionPane.showMessageDialog(this, "Bill can only be generated for an approved appointment. Current status: "
            + currentAppointment.getStatus());currentAppointment = null;
            return;
        }
        
        txtTreatmentFee.setText(String.format("%.2f", currentAppointment.getTreatmentFee()));
    ...
    private void btnCalculateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCalculateActionPerformed
        ...
        if (discount < 0 || discount > currentAppointment.getTreatmentFee() + CONSULTATION_FEE) {
            JOptionPane.showMessageDialog(this, "Invalid discount amount.");
            return;
        }
        
        Bill b = new Bill();
        b.setTreatmentFee(currentAppointment.getTreatmentFee());
        b.setConsultationFee(CONSULTATION_FEE);
        b.setDiscount(discount);
        double total = b.calculateTotal();
        txtTotal.setText(String.format("%.2f", total));
        txtReceipt.setText("SUNRISE DENTAL CLINIC"
                + "\nPATIENT BILL"
                + "\n==============================="
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        if (currentAppointment == null || txtTotal.getText().trim().isEmpty()) {
            JOptionPane.showMessageDialog(this, "Calculate the bill first.");
            return;
        }
        
        Bill b = new Bill();
        b.setAppointmentNo(currentAppointment.getAppointmentNo());
        b.setTreatmentFee(currentAppointment.getTreatmentFee());
        b.setConsultationFee(CONSULTATION_FEE);
        b.setDiscount(Double.parseDouble(txtDiscount.getText().trim()));
        b.setTotal(Double.parseDouble(txtTotal.getText().trim()));
        
        if (new BillDAO().saveBill(b))
            JOptionPane.showMessageDialog(this, "Bill saved successfully.");
        
        else
            JOptionPane.showMessageDialog(this, "Unable to save bill.");
