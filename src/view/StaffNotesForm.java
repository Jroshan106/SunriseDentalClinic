...
public class StaffNotesForm extends javax.swing.JFrame {
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        Appointment a = new AppointmentDAO().getAppointmentByNo(no);
        if (a == null) {
            txtNotes.setText("");
        ...
        List<PatientNote> notes = new PatientNoteDAO().getNotesByAppointment(no);
        StringBuilder sb = new StringBuilder("SUNRISE DENTAL CLINIC"
        ...
        if (notes.isEmpty()) {
            sb.append("No special notes have been added.\n");
        } 
        
        else {
            for (PatientNote n : notes) {
                sb.append("Dentist: ").append(n.getDentistName()).append
    ...
    private void btnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPrintActionPerformed
        if (txtNotes.getText().trim().isEmpty()) {
            JOptionPane.showMessageDialog(this, "Search for patient notes first.");
            return;
        }
